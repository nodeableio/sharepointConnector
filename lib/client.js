module.exports = function(params){
  ...
  var clientObj={};
  clientObj.url = (params.url.substr(params.url.length - 14) === 'sharepoint.com') ? params.url : params.url.substring(0,params.url.lastIndexOf("/"));
  clientObj.federatedAuthUrl = params.federatedAuthUrl;
  clientObj.auth = {};
  clientObj.siteContext = (params.url.substr(params.url.length - 14) === 'sharepoint.com') ? 'web' : params.url.substring(params.url.lastIndexOf('/') + 1);
