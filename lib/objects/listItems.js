...
module.exports = function(client) {
  var doRequest = require('../util/doRequest')(client),
    ...
    crudl = {
      ...
      query: function(listId, query, cb) {

        var host = client.BASE_LIST_URL +  "/getByTitle('" + listId + "')" + "/Items";

        host = urlBuilder.augmentURL(host, false, query.where || client.filterFields , query.select || client.expandFields, client.expandFields, query.or || client.orOperator, client.andOrOperator);
      ...
      update: function(listId, listItem, cb) {
        ...
        doRequest({
          ...
          if (err) {
            ...
            var host = client.BASE_LIST_URL +  "/getByTitle('" + listId + "')" + "/Items(" + listItem.Id + ")";
